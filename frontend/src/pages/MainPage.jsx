  ...
  return (
    <div className="min-h-screen bg-base-200">
      <header className="w-full bg-base-100 shadow">
        <div className="flex items-center justify-between w-full px-12 py-4 max-w-screen-2xl mx-auto">
          <span className="text-2xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent select-none">
            Avgen
          </span>
          <a
